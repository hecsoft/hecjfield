...
$document->addStyleSheet(JUri::root() . 'media/com_fieldtest/css/list.css');

$user      = JFactory::getUser();
$userId    = $user->get('id');
$listOrder = $this->state->get('list.ordering');
$listDirn  = $this->state->get('list.direction');
$canOrder  = $user->authorise('core.edit.state', 'com_fieldtest');
$saveOrder = $listOrder == 'a.`ordering`';

if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_fieldtest&task=tables.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_fieldtest&view=tables'); ?>" method="post"
	...
	<?php echo JHtml::_('jgrid.published', $item->state, $i, 'tables.', $canChange, 'cb'); ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_fieldtest&task=table.edit&id='.(int) $item->id); ?>">
