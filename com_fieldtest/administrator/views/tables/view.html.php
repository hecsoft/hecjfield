...
/**
 * View class for a list of Fieldtest.
 *
 * @since  1.6
 */
class FieldtestViewTables extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		FieldtestHelper::addSubmenu('tables');
	...
	{
		require_once JPATH_COMPONENT . '/helpers/fieldtest.php';

		$state = $this->get('State');
		$canDo = FieldtestHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_FIELDTEST_TITLE_TABLES'), 'tables.png');
		...
		if (file_exists($formPath))
		{
			if ($canDo->get('core.create'))
			{
				...
				JToolbarHelper::custom('tables.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
			}
		...
		{
			JToolBarHelper::preferences('com_fieldtest');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_fieldtest&view=tables');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => JText::_('COM_FIELDTEST_TABLES_NAME'),
		);
	}
}
